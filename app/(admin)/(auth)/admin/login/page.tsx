    ...
    <div className="min-h-screen bg-gradient-to-br from-primary-950 via-primary-900 to-sage-800 flex items-center justify-center p-4">
      ...
      <div className="relative w-full max-w-md">
        ...
        <div className="bg-white rounded-2xl shadow-2xl shadow-black/30 p-8">
          <h2 className="font-display text-xl font-bold text-gray-900 mb-1">Selamat Datang</h2>
          <p className="text-gray-500 text-sm mb-6">Masuk ke panel administrasi desa</p>
          <LoginForm />
        </div>

        <p className="text-center text-primary-400 text-xs mt-6">
          © {new Date().getFullYear()} Pemerintah Desa Sukobubuk
        </p>
      </div>
    </div>
  )
