  ...
  return (
    <div className="flex flex-col gap-6 max-w-3xl">
      <div>
        ...
        <h1 className="font-display text-2xl font-medium text-stone-800">Tambah UMKM</h1>
        <p className="text-stone-500 text-sm mt-1">Daftarkan UMKM baru ke direktori desa</p>
      </div>
